...
CC=gcc
LFLAGS=-Wall -Werror 
ARRAYFILES=selection_sort_array.c main.c swap_element_arr.c display_arr.c bubble_sort_array.c insertion_sort_array.c merge_sort_array.c quick_sort_array.c
